...
public class ConsoleTable {
    ...
    public static void main(String[] args) {
        ...
        //t.columnLen = new int[]{50,50,50,50,50,50,50,50};
        t.appendRow();
        t.appendColumn("id")
                .appendColumn("brand")
                .appendColumn("style")
        ...
        t.appendRow();
        t.appendColumn("A001")
                .appendColumn("branddfsfa")
                .appendColumn("styleklsfjskklsd顺丰")
                .appendColumn("color折")
                .appendColumn("size324")
                .appendColumn("numfeew")
                .appendColumn("price 磊")
                .appendColumn("descript花见花开猴急猴急和客户姐ion");
